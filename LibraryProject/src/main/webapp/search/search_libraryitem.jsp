...
%>
        <form name="form1" method="post" action="../search/search_libraryitem.jsp?<%= queryParameter%>">
...
<form name='userList' action='/JavaLibrary/servlet/sjservlets.FormProcess'>
        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="1" align="center">
          <tr> 
            <td width="2%"></td>
            <th width="36%" bgcolor="#D3DCE3"><b>Title*</b> <a href=../search/search_libraryitem.jsp?&queryOrderField=itemTitle&queryOrderType=ASC&<%= queryParameter%>> 
            ...
            <th width="21%" bgcolor="#D3DCE3"><b>Subject</b> <a href=../search/search_libraryitem.jsp?&queryOrderField=itemSubject&queryOrderType=ASC&<%= queryParameter%>> 
            ...
            <th width="13%" bgcolor="#D3DCE3"><b>Media</b> <a href=../search/search_libraryitem.jsp?&queryOrderField=itemMediaType&queryOrderType=ASC&<%= queryParameter%>> 
            ...
            <th width="15%" bgcolor="#D3DCE3"><b>Lang</b> <a href=../search/search_libraryitem.jsp?&queryOrderField=itemLanguage&queryOrderType=ASC&<%= queryParameter%>> 
    	...
    	if (myResultSet != null){
			...
			try{
				while(myResultSet.next()) {
					...
					out.println("</TD><TD><a href='/JavaLibrary/libraryitem/libraryitem_view.jsp?itemRecNumber=" +myResultSet.getString("itemRecNumber") +"'>" +myResultSet.getString("itemTitle") +"</a>");
