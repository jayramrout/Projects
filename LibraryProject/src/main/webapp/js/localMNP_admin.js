...
if (ToolBar_Supported != null && ToolBar_Supported == true)
{
	...
	addICPSubMenu("AdminMenu", "Library Item List", "../admin/libraryitem_list.jsp");
	addICPSubMenuLine("AdminMenu");
	addICPSubMenu("AdminMenu", "Borrow List", "../admin/borrow_list.jsp");
	addICPSubMenu("AdminMenu", "Reserve List", "../admin/reserve_list.jsp");
	addICPSubMenu("AdminMenu", "Penalty List", "../admin/penalty_list.jsp");	
