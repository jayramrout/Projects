...
if (ToolBar_Supported)
{
	...
	HTMLStr = 
		...
		"<DIV ID='idMSMenuCurve' STYLE='position:absolute;top:0;left:250;height:20;width:18;overflow:hidden;vertical-align:top;'><IMG SRC='../images/common/curve.gif' BORDER=0></DIV>" +
...
{
	var TG = '<LAYER visibility="hide"><div style="display:none;"><IMG src="../%27%20%2B%20location.protocol%20%2B%20%27//c.microsoft.com/trans_pixel.asp?%27;%0A%09for(var%20i=0;%20i%3CpArr.length;%20i%2B%2B)%0A%09%7B%0A%09%09if(0%20==%20i)%0A%09%09%7B%0A%09%09%09TG%20%2B=%20%20pArr%5Bi%5D;%0A%09%09%7D%0A%09%09else%0A%09%09%7B%0A%09%09%09TG%20%2B=%20%27&%27%20%2B%20pArr%5Bi%5D;%0A%09%09%7D%0A%09%7D%0A%09TG%20%2B=%27" height="0" width="0" hspace="0" vspace="0" Border="0"></div></layer>';
    document.writeln(TG);
    return;
}
