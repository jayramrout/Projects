...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr bgcolor="#f1f1f1"> 
    ...
    <td valign="top" width="100%" bgcolor="#f1f1f1"> 
      <div align="center">
        <p><b>Database Process Result</b></p>
        <p>
<%	
	// Display the database process result from dbprocess java bean
	//out.println("Database: " +dbprocess.getDBName() +"<br>");
	//out.println("Table: " +dbprocess.getTblName() +"<br>");
	//out.println("SQL: " +dbprocess.getSQLQuery() +"<br");
	out.println(dbprocess.getProcessResult() +"<br><br>");
	out.println(dbprocess.getProcessMsg() +"<p>");
	out.println(dbprocess.getProcessAction() +"<br>");
%>
</p>
      </div>
    </td>
