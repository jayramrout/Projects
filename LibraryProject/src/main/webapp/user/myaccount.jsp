...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr bgcolor="#f1f1f1"> 
    ...
    <td valign="top" width="100%" bgcolor="#f1f1f1">
      <center><b>My Account</b></center><br>
		<jsp:setProperty name="form" property="formName" value="user" />
		<jsp:setProperty name="form" property="formType" value="edit" />
		<jsp:setProperty name="form" property="formURL" value="/JavaLibrary/user/myaccount.jsp" />
		<% 
			// Checking either login user is staff (librarian or admin), if so then transfer the
			// user bean info to staff bean
